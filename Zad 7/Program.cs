...
namespace Zad_7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int a;
            Console.WriteLine("Wpisz liczbę od 1 do 3999:");
            ...
            switch (a)
            {
                ...
                default: Console.Write("koniec"); break;
            ...
            else if (a>= 90) { a -= 90; Console.Write("XC"); }
            ...
            else if (a >= 600) { a -= 600; Console.Write("DM"); }
            else if (a >= 700) { a -= 700; Console.Write("DMM"); }
            else if (a >= 800) { a -= 800; Console.Write("DMMM"); }
            else if (a >= 900) { a -= 900; Console.Write("CM"); }
